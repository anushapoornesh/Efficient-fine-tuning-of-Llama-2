...
class Attention(nn.Module):
    ...
    def __init__(self, args: ModelArgs):
        ...
        self.wq = LoRALinear(args.dim, args.n_heads * self.head_dim, bias=False)
        self.wk = nn.Linear(args.dim, self.n_kv_heads * self.head_dim, bias=False)
        # self.wv = nn.Linear(args.dim, self.n_kv_heads * self.head_dim, bias=False)
        self.wv = LoRALinear(args.dim, self.n_kv_heads * self.head_dim, bias=False)
    ...
    def forward(
        ...
        return torch.utils.checkpoint.checkpoint(self.attention_scores, x, freqs_cis, mask, use_reentrant = True)
